...
// Exact copy of expo-dev-menu/ios/Launch/ExpoLauncherURL.swift because Expo Go's Podfile excludes expo-dev-menu.
...
/**
 ...
 Keep in sync with `expo-dev-menu/android/src/debug/java/expo/modules/devmenu/launch/ExpoLauncherUrl.kt`.
 */
