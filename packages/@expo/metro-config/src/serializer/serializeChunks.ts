...
type ChunkOptions = ExpoSerializerOptions & { isLazyBundle: boolean };
  ...
  private serializeToCodeWithTemplates(
    ...
    const jsSplitBundle = getBaseJSBundleWithDependencies()(entryFile, preModules, dependencies, {
      ...
      ...(this.options.chunkingStrategy === 'bitset' && {
        chunkCompletion: this.isAsync && !this.sealed,
